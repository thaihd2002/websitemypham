    ...
    <body>
        ...
        <section id="product1" class="section-p1 p-shop">
                ...
                <ul class="category-list">
                    ...
                    <li>
                       Sản Phẩm Hót !!!!!
                        ...
                        <ul>
                            <li class="hot_pro"><a href="#">
                                <div class="hot_pro--img"><img  src="./anh/sanpham/25.jpg" alt=""></div>
                                <span>Kem chống nắng</span>
                            </a></li>
                        </ul>
                        <ul>
                            <li class="hot_pro"><a href="#">
                                <div class="hot_pro--img"><img  src="./anh/sptreda/2.jpg" alt=""></div>
                                <span>Kem thải độc tố trị nám</span>
                            </a></li>
                        </ul>
                        <ul>
                            <li class="hot_pro"><a href="#">
                                <div class="hot_pro--img"><img  src="./anh/sptreda/3.jpg" alt=""></div>
            ...
            <div class="pro-container">
                <div class="pro">
                    <img src="./anh/sanpham/18.jpg" alt="">
                    <div class="des">
                        <span>Thương Hiệu Khác</span>
                        <h5>Kem Dưỡng Da Obagi Medical Retinol 1.0 Cream</h5>
                        <div class="star">
                ...
                <div class="pro">
                    <img src="./anh/sanpham/19.jpg" alt="">
                    <div class="des">
                        <span>Thương Hiệu Khác</span>
                        <h5>Son Thỏi Shu Uemura Pokémon Rouge Unlimited</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro">
                    <img src="./anh/sanpham/20.jpg" alt="">
                    <div class="des">
                        <span>Thương Hiệu Khác</span>
                        <h5>Mặt Nạ Naruko Tea Tree Mask Sheet 25ml</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro">
                    <img src="./anh/sanpham/21.jpg" alt="">
                    <div class="des">
                        <span>Laneige</span>
                        <h5>Mặt Nạ Ngủ Laneige Water Sleeping Mask 15ml</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
            ...
            <div class="pro-container">
                <div class="pro">
                    <img src="./anh/sanpham/22.jpg" alt="">
                    <div class="des">
                        <span>Thương Hiệu Khác</span>
                        <h5>Son Tint Merzy The Watery Dew Tint 4gr</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro">
                    <img src="./anh/sanpham/23.jpg" alt="">
                    <div class="des">
                        <span>Thương Hiệu Khác</span>
                        <h5>Miếng Giảm Mụn Đầu Đen Ciracle Goodbye 5ml</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro">
                    <img src="./anh/sanpham/24.jpg" alt="">
                    <div class="des">
                        <span>Cocoon</span>
                        <h5>Nước Dưỡng Tóc Cocoon Tinh Dầu Bưởi Pomelo Hair Tonic 140ml</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="pro">
                    <img src="./anh/sanpham/25.jpg" alt="">
                    <div class="des">
                        <span>Thương Hiệu Khác</span>
                        <h5>Kem Chống Nắng The Saem Eco Earth Pink SunCream</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
